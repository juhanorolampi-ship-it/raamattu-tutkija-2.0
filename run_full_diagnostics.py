...
LOG_FILENAME = 'full_diagnostics_report_final_C.txt'
...
def run_diagnostics():
    ...
    log_header(
        "Raamattu-tutkija 2.0 - DIAGNOSTIIKKA-AJO (Tarkennettu haku)")
